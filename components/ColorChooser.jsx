...
// Here's an example of separating out a component or group of components
...
const ColorChooser = ({ colors }) => (
  <Fieldset model=".appearance">
    ...
    <Control.select model=".color" className="u-full-width"
      validators={{
        isChartreuse: color => color !== 'chartreuse'
      }}
    ...
    <Errors model=".color" className="error"
      messages={{
        isChartreuse: "Nobody likes chartreuse."
      }}
      show="touched"
    />
